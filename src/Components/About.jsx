      ...
      <div className="max-w-screen-xl p-4 mx-auto max-w-7xl">
        ...
        <div className="space-y-8 mt-8">
          ...
          <div>
            ...
            Master's in 2021 with a Masters of Technology in Computer Science from Pune University, attaining a commendable academic performance with a CGPA of 8.8.
            </p>
          </div>
