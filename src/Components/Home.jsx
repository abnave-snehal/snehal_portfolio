      ...
      <div className="mx-auto flex flex-col items-center md:justify-center h-[calc(100vh-100px)] px-4 md:flex-row">
        ...
        <div className="flex flex-col justify-center p-3 md:p-16">
          ...
          <div className="flex gap-4 mt-4">
            ...
            <a
              href="https://drive.google.com/file/d/1onc5vKMiqWK6d6pw65Kp-QJ8NMi12B4q/view?usp=sharing"
              target="_blank"
        ...
        {/* Image section */}
        <div className="flex w-[280px] h-[280px] md:w-[400px] md:h-[400px] items-center justify-center pt-8">
          <img
            src={HeroImg}
            alt="My Profile"
