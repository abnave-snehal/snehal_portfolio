  ...
  const socialLinks = [
    {
      ...
      href: "https://www.linkedin.com/in/snehal-abnave/",
      label: "LinkedIn",
    ...
    },
    {
      ...
      href: "mailto:aalegaonkar712@gmail.com",
      label: "Email",
        ...
        <div className="bg-gray-900/50 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col justify-center space-y-8 mx-4">
              ...
              <form
                action="https://formsubmit.co/25c1effb9fc1b04ec0537d8aeb5b3601"
                method="POST"
              >
