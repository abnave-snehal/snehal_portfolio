...
import logo from "../assets/portfolio/seenIT.png";
            ...
            <div className="sm:w-1/6 w-full flex flex-col items-center justify-center mx-auto space-y-2 ">
              ...
              <div className="text-center sm:text-left">
                <div className="flex items-center gap-2 text-gray-300">
                  <Calendar size={16} />
                  <p>Feb 2025 - Oct 2025</p>
                </div>
                <div className="flex items-center gap-2 text-gray-300 mt-1">
                  <Building2 size={16} />
                  <p>SeenIt Solutions Pvt Ltd, Pune</p>
                </div>
              </div>
            </div>
            {/* right */}
            <div className="w-full sm:w-5/6">
              <ul className="list-disc space-y-2">
                <li className="text-lg leading-relaxed">
                  I have {experience} years of experience as a Frontend developer. I have Gained experience in 
                  programming languages such as HTML, CSS, JavaScript, React and
                  Node.js.
                </li>
                <li className="text-lg leading-relaxed">
                Developed and maintained responsive landing pages for various campaigns, resulting in improved user engagement and better conversion rates.
                </li>
                <li className="text-lg  leading-relaxed">
